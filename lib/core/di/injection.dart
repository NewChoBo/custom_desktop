...
class DependencyInjection {
  ...
  void initialize() {
    ...
    _initializeSystemTrayUseCase = InitializeSystemTrayUseCase(
      _systemTrayRepository,
    );
    _setTrayIconUseCase = SetTrayIconUseCase(_systemTrayRepository);
    _setTrayContextMenuUseCase = SetTrayContextMenuUseCase(
      _systemTrayRepository,
    );
  ...
  InitializeWindowUseCase get initializeWindowUseCase =>
      _initializeWindowUseCase;
  ...
  InitializeSystemTrayUseCase get initializeSystemTrayUseCase =>
      _initializeSystemTrayUseCase;
  SetTrayIconUseCase get setTrayIconUseCase => _setTrayIconUseCase;
  SetTrayContextMenuUseCase get setTrayContextMenuUseCase =>
      _setTrayContextMenuUseCase;
